...
const DICT: Record<string, LangPack> = {
  ...
  en: {
    ...
    threads: { all:'All Regions', arabia:'Arabia / Islamic', china:'China', india:'South Asia', europe:'Europe / Atlantic', steppe:'Eurasian Steppe', africa:'Sub-Saharan Africa', americas:'Americas', oceania:'Oceania' },
  ...
  es: {
    ...
    threads: { all:'Todas las regiones', arabia:'Arabia / Islámico', china:'China', india:'Asia del Sur', europe:'Europa / Atlántico', steppe:'Estepa euroasiática', africa:'África subsahariana', americas:'Américas', oceania:'Oceanía' },
  ...
  fr: {
    ...
    threads: { all:'Toutes les régions', arabia:'Arabie / Islamique', china:'Chine', india:'Asie du Sud', europe:'Europe / Atlantique', steppe:'Steppe eurasienne', africa:'Afrique subsaharienne', americas:'Amériques', oceania:'Océanie' },
  ...
  de: {
    ...
    threads: { all:'Alle Regionen', arabia:'Arabien / Islamisch', china:'China', india:'Südasien', europe:'Europa / Atlantik', steppe:'Eurasische Steppe', africa:'Subsahara-Afrika', americas:'Amerika', oceania:'Ozeanien' },
  ...
  pt: {
    ...
    threads: { all:'Todas as regiões', arabia:'Arábia / Islâmico', china:'China', india:'Sul da Ásia', europe:'Europa / Atlântico', steppe:'Estepe euroasiática', africa:'África subsaariana', americas:'Américas', oceania:'Oceania' },
  ...
  it: {
    ...
    threads: { all:'Tutte le regioni', arabia:'Arabia / Islamico', china:'Cina', india:'Asia meridionale', europe:'Europa / Atlantico', steppe:'Steppa eurasiatica', africa:'Africa subsahariana', americas:'Americhe', oceania:'Oceania' },
  ...
  zh: {
    ...
    threads: { all:'所有地区', arabia:'阿拉伯 / 伊斯兰', china:'中国', india:'南亚', europe:'欧洲 / 大西洋', steppe:'欧亚草原', africa:'撒哈拉以南非洲', americas:'美洲', oceania:'大洋洲' },
  ...
  ja: {
    ...
    threads: { all:'すべての地域', arabia:'アラビア / イスラム', china:'中国', india:'南アジア', europe:'ヨーロッパ / 大西洋', steppe:'ユーラシア草原', africa:'サハラ以南アフリカ', americas:'南北アメリカ', oceania:'オセアニア' },
  ...
  ar: {
    ...
    threads: { all:'كل المناطق', arabia:'العرب / الإسلامي', china:'الصين', india:'جنوب آسيا', europe:'أوروبا / الأطلسي', steppe:'السهوب الأوراسية', africa:'أفريقيا جنوب الصحراء', americas:'الأمريكتان', oceania:'أوقيانوسيا' },
  ...
  hi: {
    ...
    threads: { all:'सभी क्षेत्र', arabia:'अरब / इस्लामी', china:'चीन', india:'दक्षिण एशिया', europe:'यूरोप / अटलांटिक', steppe:'यूरेशियाई स्तेपी', africa:'उप-सहारा अफ्रीका', americas:'अमेरिका', oceania:'ओशिनिया' },
  ...
  ru: {
    ...
    threads: { all:'Все регионы', arabia:'Аравия / Исламский мир', china:'Китай', india:'Южная Азия', europe:'Европа / Атлантика', steppe:'Евразийская степь', africa:'Африка южнее Сахары', americas:'Америки', oceania:'Океания' },
